...
export const translations = {
  ...
  boxCodeNote1: t(
    '📌 Bitte nach Entnahme den Schlüssel wieder sicher verschließen.',
  ...
  familyItems: {
    ...
    dishes: t(
      ...
      'Children\'s dishes in the lower kitchen drawer',
      'Vajilla infantil en el cajón inferior de la cocina',
      'Stoviglie per bambini nel cassetto inferiore della cucina',
      'Vaisselle pour enfants dans le tiroir inférieur de la cuisine',
      'Kinderservies in de onderste keukenlade',
    ),
    games: t(
      'Spiele & Bücher im Wohnbereich',
      'Games & books in the living area',
      'Juegos y libros en la sala de estar',
      'Giochi e libri nel soggiorno',
      'Jeux et livres dans le salon',
  ...
  checkoutItems: {
    ...
    waste: t('Restmüll, Altpapier und Biomüll in die Tonnen vor der Haustür', 'Residual waste, paper and organic waste in the bins at the front door', 'Basura, papel y orgánico en los contenedores de la puerta', 'Rifiuti, carta e organico nei bidoni davanti alla porta', 'Déchets, papier et bio dans les poubelles devant la porte', 'Restafval, papier en GFT in de bakken bij de voordeur'),
  ...
  saunaGuide: t('🧖 Sauna einschalten', '🧖 Turning on the sauna', '🧖 Encender la sauna', '🧖 Accendere la sauna', '🧖 Allumer le sauna', '🧖 Sauna aanzetten'),
  saunaSteps: [
    t('Saunaofen am Drehregler (außen an der Kabine) einschalten.', 'Turn on sauna heater at the dial (outside the cabin).', 'Encender el calentador en el regulador (exterior de la cabina).', 'Accendere la stufa con la manopola (esterno della cabina).', 'Allumer le poêle au bouton (à l\'extérieur de la cabine).', 'Saunakachel inschakelen met de draaiknop (buiten de cabine).'),
    t('Gewünschte Temperatur einstellen (empfohlen: 70–85 °C).', 'Set desired temperature (recommended: 70–85 °C).', 'Ajustar temperatura deseada (recomendado: 70–85 °C).', 'Impostare la temperatura desiderata (consigliato: 70–85 °C).', 'Régler la température souhaitée (recommandé : 70–85 °C).', 'Gewenste temperatuur instellen (aanbevolen: 70–85 °C).'),
    t('Aufheizzeit ca. 30–45 Minuten abwarten.', 'Wait approx. 30–45 minutes for heating.', 'Esperar aprox. 30–45 minutos para calentar.', 'Attendere circa 30–45 minuti per il riscaldamento.', 'Attendre env. 30–45 minutes pour le chauffage.', 'Wacht ca. 30–45 minuten opwarmtijd.'),
    ...
    t('Nach der Nutzung: Regler auf 0 drehen und kurz lüften.', 'After use: turn dial to 0 and ventilate briefly.', 'Después de usar: regulador a 0 y ventilar brevemente.', 'Dopo l\'uso: manopola a 0 e ventilare brevemente.', 'Après utilisation : bouton à 0 et aérer brièvement.', 'Na gebruik: knop op 0 draaien en kort ventileren.'),
  ],
