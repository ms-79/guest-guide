...
export const translations = {
  ...
  saunaSteps: [
    t('Einschalten: Power-Taste oben rechts am Bedienfeld ca. 3 Sekunden gedrückt halten, bis der Ladekreis voll ist – die Sauna startet.', 'Switch on: press and hold the power button (top right of the panel) for ~3 seconds until the circle is fully loaded – the sauna starts.', 'Encender: mantener pulsado el botón de encendido (arriba a la derecha) ~3 segundos hasta que el círculo esté completo.', 'Accensione: tenere premuto il pulsante di accensione (in alto a destra) ~3 secondi finché il cerchio è completo.', 'Allumer : maintenir le bouton d\'alimentation (en haut à droite) ~3 secondes jusqu\'à ce que le cercle soit complet.', 'Inschakelen: aan/uit-knop (rechtsboven) ~3 seconden ingedrukt houden tot de cirkel vol is – de sauna start.'),
